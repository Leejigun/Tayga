...
import com.dopy.dopy.tayga.databinding.ActivityYoutubeSampleBinding;
...
public class YoutubeSampleActivity extends FragmentActivity {
  ...
  private ActivityYoutubeSampleBinding binding;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    binding = DataBindingUtil.setContentView(this, R.layout.activity_youtube_sample);
